...
static struct test_t dpe_s_tests[] = {
    ...
    {&certify_key_core_functionality_test_01, "DPE_S_TEST_1018",
     "DPE CertifyKey functionality - finalized layer"},
    {&certify_key_core_functionality_test_02, "DPE_S_TEST_1019",
     "DPE CertifyKey functionality - unfinished layer"},
    {&certify_key_retain_context_test, "DPE_S_TEST_1020",
     "DPE CertifyKey - retain context"},
    {&certify_key_incorrect_handle_test, "DPE_S_TEST_1021",
     "DPE CertifyKey - invalid handle"},
    {&certify_key_supplied_pub_key_test, "DPE_S_TEST_1022",
     "DPE CertifyKey - supplied public key"},
    {&certify_key_supplied_label_test, "DPE_S_TEST_1023",
     "DPE CertifyKey - supplied label"},
    {&certify_key_smaller_cert_buffer_test, "DPE_S_TEST_1024",
     "DPE CertifyKey - invalid certificate chain buffer size"},
    {&certify_key_smaller_derived_pub_key_buffer_test, "DPE_S_TEST_1025",
     "DPE CertifyKey - invalid public key buffer size"},
    {&certify_key_invalid_cbor_encoded_input_test, "DPE_S_TEST_1026",
     "DPE CertifyKey - invalid cbor encoded input"},
    {&certify_key_without_optional_args_test, "DPE_S_TEST_1027",
     "DPE CertifyKey - without optional arguments"},
    {&certify_key_with_unsupported_params_test, "DPE_S_TEST_1028",
     "DPE CertifyKey - with unsupported parameters"},
    {&derive_context_with_parent_leaf_component_test, "DPE_S_TEST_1029",
